...
class SimpleFrameWidget(ScriptedLoadableModuleWidget):
    ...
    def __init__(self, parent):
        super(SimpleFrameWidget, self).__init__(parent)
    ...
    def load_frame_mrb(self):
        ...
        mrml_path = slicer.modules.simpleframe.path
        mrml_path = (
    ...
    def update_nodes(self):
        ...
        """
        arc_angle = -1 * (self.arc_angle_widget.value - 90)
